...
MODEL =  FleetManagerTasks


# Register your models here using the student_site
class FleetManagerTaskCustomAdminsite(admin.ModelAdmin):
    list_display = ['order','rider']
    ...
    def get_queryset(self, request: HttpRequest) -> QuerySet[Any]:
        ...
        if request.user.is_superuser:
            return queryset
        quest =  queryset.filter(account_type='manager')
        return quest
...
superadmin_dashboard_site.register(MODEL, FleetManagerTaskCustomAdminsite)
